...
void Pair::ev_tally3_1(int i, int j, int k, double evdwl, double ecoul,
                     double *fj, double *fk, double *drji, double *drki,double evj,double evk)
{
  double epairthird,v[6];
 ...
 // evk=evj=0;
  if (vflag_either) {
    v[0] = drji[0]*fj[0]*evk + drki[0]*fk[0]*evj;
    v[1] = drji[1]*fj[1]*evk + drki[1]*fk[1]*evj;
    v[2] = drji[2]*fj[2]*evk + drki[2]*fk[2]*evj;
    v[3] = drji[0]*fj[1]*evk + drki[0]*fk[1]*evj;
    v[4] = drji[0]*fj[2]*evk + drki[0]*fk[2]*evj;
    v[5] = drji[1]*fj[2]*evk + drki[1]*fk[2]*evj;
