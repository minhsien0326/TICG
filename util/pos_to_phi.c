...
- Modify the while(!feof(fp)) condition such that the loop is driven by success/failure of the actual read calls. 
------------- HISTORY ------------------------------------------------------------------------------
Version 1.0: 
...
#define DL           0.80                   // discretization length 
// ---------- Data Structures -------------------------------------------------- 
// chain bookkeeping 
...
// ---------- File I/O --------------------------------------------------------- 
    ...
    // char inputPath[256] = "./lammps-dump/smolBox_NPT_XN4p69_BB.txt"; 
    // char outputPath[256] = "./lammps-grid/smolBox_NPT_XN4p69_BB.txt";

    char inputPath[256] = "./lammps-dump/smolBox_NPT_XN4p69_BV.txt"; 
    char outputPath[256] = "./lammps-grid/smolBox_NPT_XN4p69_BV.txt";     
